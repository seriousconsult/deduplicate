...
Pick two folders, then add zero or more extensions (one at a time; Enter with no text finishes). None selected means all files. Extensions longer than 10 characters are rejected.
